...
const RelationshipImprovement = ({ formData, setFormData }) => {
  const [accordionStates, setAccordionStates] = useState({
    RelationshipImprovementState: true,
  });
  ...
  return (
    <main className="pt5 black-80" style={{ maxWidth: "50%", maxHeight: "25%", margin: "auto" }}>
      ...
      <Lot10
        ...
        items={RelationshipImprovement}
        accordionState={accordionStates.RelationshipImprovementState}
        handleAccordionChange={handleAccordionChange("RelationshipImprovementState")}
        checked={checked}
...
export default RelationshipImprovement;
